                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item mt-5">
                            <a href="#" class='sidebar-link text-muted' style="background-color: transparent; border: 1px solid rgba(108, 117, 125, 0.2);">
                                <i class="bi bi-life-preserver text-muted"></i>
                    ...
                    <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12 mb-2 mt-3">
                                <h5 class="text-subtitle text-muted">Rack 01 - Servidores Principales</h5>
                            </div>
                            <!-- Sensor de Temperatura -->
                            <div class="col-6 col-lg-3 col-md-6">
                                <div class="card">
                                    <div class="card-body px-4 py-4-5 d-flex flex-column align-items-center text-center">
                                        <div class="stats-icon blue mb-3 d-flex align-items-center justify-content-center">
                            ...
                            <div class="col-6 col-lg-3 col-md-6">
                                <div class="card">
                                    <div class="card-body px-4 py-4-5 d-flex flex-column align-items-center text-center">
                                        <div class="stats-icon purple mb-3 d-flex align-items-center justify-content-center">
                            ...
                            <div class="col-6 col-lg-3 col-md-6">
                                <div class="card">
                                    <div class="card-body px-4 py-4-5 d-flex flex-column align-items-center text-center">
                                        <div class="stats-icon text-white mb-3 d-flex align-items-center justify-content-center" style="background-color: #f59e0b;">
                            ...
                            <div class="col-6 col-lg-3 col-md-6">
                                <div class="card">
                                    <div class="card-body px-4 py-4-5 d-flex flex-column align-items-center text-center">
                                        <div class="stats-icon red mb-3 d-flex align-items-center justify-content-center">
                        ...
                        <div class="row">
                            <div class="col-12 mb-2 mt-3">
                                <h5 class="text-subtitle text-muted">Rack 02 - Almacenamiento</h5>
                            </div>
                            <!-- Sensor de Temperatura -->
                            <div class="col-6 col-lg-3 col-md-6">
                                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-12 mb-2 mt-3">
                                <h5 class="text-subtitle text-muted">Rack 03 - Redes y Switches</h5>
                            </div>
                            <!-- Sensor de Temperatura -->
                            <div class="col-6 col-lg-3 col-md-6">
                                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-12 mb-2 mt-3">
                                <h5 class="text-subtitle text-muted">Rack 04 - Respaldo</h5>
                            </div>
                            <!-- Sensor de Temperatura -->
                            <div class="col-6 col-lg-3 col-md-6">
                                <div class="card">
